...
def check33_4tmpfiles():
    files = os.listdir("./")
    for f in files:
        if f == "pixval.txt" or f == "mpixval.txt" or f == "data.txt":
            print("WARNING, this program creates some temporary files like pixval.txt, mpixval.txt, data.txt")
            print("So please rename or move it to the other directory")
            print("Other-Wise you may lose the data stored in it.")
            quit()
